...
<div class="container_forms">
    <form action="php/create_arreglo.php" method="post" id="form_a">
    ...
    <h3> Nueva reparacion </h3>
            ...
            <?php
                ...
                $idc = $_GET['id'];
                echo "<b>Patente:</b> " . $patente; 
                echo "<b>ID:</b> " . $idc; 
                echo "<br>";
            ?>
            <br>
            <label for="km"> Kilometros al ingresar al taller: </label>
            <br>
            <input required name="km" type="text" id="km">
            <br>

            <label for="fecha_i"> Fecha de ingreso del vehiculo: </label>
            <br>
            <input required name="fecha_i" type="date" id="fecha_i">
            <br>

            <label for="fecha_s"></label>
            <br>
            <input type="hidden" id="fecha_s" name="fecha_s">
            <br>

            <label for="descripcion"> Descripcion del arreglo: </label>
            <br>
            <textarea required name="descrip_arreglo" id="descripcion"></textarea><br>
            <br>
            
            <input type="hidden" name="patente" value="<?php echo $patente; ?>">
            <input type="hidden" name="id_cliente" value="<?php echo $idc; ?>">
            <button type="submit" class="button final-button"> Agregar reparacion </button>
    </form>
</div>
</div>
        </div>
